...
;(define (state-store-assign st k v) (state (state-var=>cx st)
...
;(define (state-var-assign st x t)
;
...
;          ;((void? val) x)
;          ;(else        val))))
;(define (walk    st t) (if (var? t) (state-var-walk    st t) t))
